...
const Wallstreet = () => {
        ...
        const fetchArticles = async () => {
            try {
                const response = await axios.get(
                    'https://newsapi.org/v2/everything?domains=wsj.com&apiKey=f79141b2be7f493c855af2f4ea7ea02f'
                );
    ...
    return (
        <div className='Wallstreet'>
            <h1>News Articles</h1>
            <div className='Wallstreet-Inner' style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
